...
namespace CapaPresentacion
{
    public partial class fmRecuperacionContra : Form
    {
        ...
        private void EnviarCorreoContrasena(int contrasenaNueva, string correo)
        {
            ...
            string cuerpoDelMesaje = "Hola! Usted a solicitado una Nueva contraseña " + " " + Convert.ToString(contrasenaNueva) + " esta Contraseña es provisional le recomendamos cambiar la contraseña al entrar al sistema. Muchas Gracias por usar nuestro Servicios :)";
